        ...
        <div class="wishlist-card-container justify-align">
            ...
            <article class="card image-overlay">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-text btn-info" onClick={() => cartDispatch({type: "Increase_quantity", payload: item})}>Increase quantity</button>
                    : <button class="btn btn-text btn-info" onClick = {() => cartDispatch({type: "Add_to_cart", payload: item})}>Move to Cart</button>
                    }
                    <button class="btn btn-no-bg btn-text" onClick={() => wishDispatch({type: "Remove_from_wishlist", payload: item})}>Remove <i class="fas fa-heart wish-icon"></i></button>
                </div>
            </article>
        </div>)}
        </div>
